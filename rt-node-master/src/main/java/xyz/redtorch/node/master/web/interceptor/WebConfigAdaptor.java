...
//        		"/**" //
		...
		registry.addResourceHandler("/", "/**").setCachePeriod(0).addResourceLocations("classpath:/static/ReactSPA/index.html")
				.addResourceLocations("/static/ReactSPA/index.html").resourceChain(true).addResolver(new PathResourceResolver() {
					@Override
