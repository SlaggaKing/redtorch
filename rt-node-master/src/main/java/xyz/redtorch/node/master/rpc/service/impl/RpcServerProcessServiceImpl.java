...
public class RpcServerProcessServiceImpl implements RpcServerProcessService, InitializingBean {
	...
	public void processData(int sourceNodeId, byte[] data) {
		...
		if (targetNodeId != 0) {
			logger.info("转发DEP记录,来源节点ID:{},目标节点ID：{},RPC类型:{},RPC ID:{},请求ID:{},内容类型:{},时间戳:{}", sourceNodeId, targetNodeId, sourceNodeId, rpcTypeValueName,
			...
			if (contentType == ContentType.COMPRESSED_LZ4) {
				...
				logger.error("处理DEP错误,来源节点ID:{},RPC类型:{},RPC ID:{},请求ID:{},内容类型:{},时间戳:{},不支持的报文类型", sourceNodeId, sourceNodeId, rpcTypeValueName, rpcId, reqId,
			...
			if (contentByteString == null || contentByteString.size() <= 0) {
				logger.error("处理DEP错误,来源节点ID:{},RPC类型:{},RPC ID:{},请求ID:{},时间戳:{},报文内容长度错误", sourceNodeId, sourceNodeId, rpcTypeValueName, rpcId, reqId,
						timestamp);
			...
			if (dep.getRpcType() == RpcType.CORE_RPC) {
				...
				logger.error("处理DEP错误,来源节点ID:{},RPC类型:{},RPC ID:{},请求ID:{},时间戳:{},未能识别的RPC类型", sourceNodeId, dep.getRpcType().getValueDescriptor().getName(),
						rpcId, reqId, timestamp);
			}
		}
	}
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					try {
						...
						rpcServerReqHandlerService.subscribe(rpcSubscribeReq.getCommonReq(), rpcSubscribeReq.getContract(), rpcSubscribeReq.getGatewayId());
					} catch (Exception e) {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.unsubscribe(rpcUnsubscribeReq.getCommonReq(), rpcUnsubscribeReq.getContract(),
								rpcUnsubscribeReq.getGatewayId());
					} catch (Exception e) {
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryOrderByOriginOrderId(rpcQueryOrderByOriginOrderIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryOrderListByAccountId(rpcQueryOrderListByAccountIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryOrderListByUnifiedSymbol(rpcQueryOrderListByUnifiedSymbolReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryTradeListByUnifiedSymbol(rpcQueryTradeListByUnifiedSymbolReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryTradeListByAccountId(rpcQueryTradeListByAccountIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryTradeListByOriginOrderId(rpcQueryTradeListByOriginOrderIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryPositionByPositionId(rpcQueryPositionByPositionIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryPositionListByAccountId(rpcQueryPositionListByAccountIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryPositionListByUnifiedSymbol(rpcQueryPositionListByUnifiedSymbolReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryAccountListByAccountCode(rpcQueryAccountListByAccountCodeReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryContractByContractId(rpcQueryContractByContractIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryContractListByUnifiedSymbol(rpcQueryContractListByUnifiedSymbolReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.queryContractListByGatewayId(rpcQueryContractListByGatewayIdReq.getCommonReq(),
			...
			normalExecutorService.execute(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						rpcServerReqHandlerService.syncSlaveNodeRuntimeData(rpcSyncSlaveNodeRuntimeDataReq.getCommonReq(),
